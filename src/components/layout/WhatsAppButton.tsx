...
export function WhatsAppButton() {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-8 right-8 z-[100] bg-white text-[#25D366] p-4 rounded-full shadow-[0_20px_50px_rgba(0,0,0,0.15)] border border-gray-100 hover:scale-110 transition-transform flex items-center justify-center"
